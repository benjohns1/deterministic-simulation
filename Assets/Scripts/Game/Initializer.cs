...
namespace Game
{
    public class Initializer
    {
        ...
        {
            InitialGameState = new Game.GameState();
        ...
        public void InitializeFromGameData(SerializableGame data)
        {
            ...
            foreach (SimComponent component in InitialSimState.GetComponents())
            {
                if (!createdEntities.Contains(component.EntityID))
                {
                    ...
                    GameObject gameObject = InitialGameState.InstantiateArchetype(component.EntityID, archetypeName);
                    InitialGameState.AddGameObject(component.EntityID, gameObject);
        ...
        public static IEnumerable<SimSystem> InstantiateSimSystems(Assembly assembly)
        {
            ...
            {
                yield return (SimSystem)System.Activator.CreateInstance(systemType);
            }
        }
    }
}